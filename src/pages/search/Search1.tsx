            ...
            <div className="main-content-top align-items-center d-flex justify-content-between mb-2 text-uppercase">
                ...
                <div className="d-flex">
                    ...
                    <Row className="mt-4">
                                        ...
                                        return(
                                            ...
                                            index == 1 && selectedPdfIndex <= 1 ?
                                                ...
                                                <div className="bg-white mb-4 p-4 d-flex justify-content-center zr-pdfFrame">
                                                    <iframe src={`data:application/pdf;base64,${selectedDoc}`} className="img-fluid"/>
                                            ...
                                            index == 3 && selectedPdfIndex > 1 && selectedPdfIndex <= 3 ?
                                                showFrame &&
                                                <Col lg="12">
                                            ...
                                            index == 5 && selectedPdfIndex > 3 && selectedPdfIndex <= 5 ?
                                                showFrame &&
                                                <Col lg="12">
                                            ...
                                            index == 7 && selectedPdfIndex > 5 && selectedPdfIndex <= 7 ?
                                                showFrame &&
                                                <Col lg="12">
                                                ...
                                                : 
                                                index == SearchTextResponse.data.length -1 && selectedPdfIndex == SearchTextResponse.data.length -1 ?
                                                showFrame &&
                                                <Col lg="12">
                        ...
                        // <Col xl="7">
                        <Col xl="12">
                            <div className="bg-white p-4 d-flex justify-content-center zr-pdfFrame">
                                {showFrame  ? <> 
                                <iframe src={`data:application/pdf;base64,${selectedDoc}`} className="img-fluid"/> </>   
                                : ""
                                }
