    ...
    async(data:uploadParams) =>{
        ...
        const returnVal = 
        {
            ...
            try{
                ...
                const response :any = await apiScaffolder.post(`api/Upload/UploadFile_ing`, formData
                //const response :any = await apiScaffolder.post(`/backend/upload_save`, formData
                , {
                    headers: {
...
export const getDocumentStatuses = createAsyncThunk<any, uploadRequestData[]>(
    ...
    async(req: uploadRequestData[]) =>{
            ...
            try{
                ...
                //const response :any = await apiScaffolder.post(`/api/DocSearch/GetStatuses_ing`, 
                const response: any = await apiScaffolder.post(`/get_statuses`, 
                dsr
                // ,{
                //     headers: {
                //         'Authorization': `Token ${localStorage.getItem("user")}` 
